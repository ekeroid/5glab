...
class InferenceServiceStub:
    ...
    def __init__(self, channel):
        ...
        self.Infer = channel.unary_unary(
                '/edgevision.InferenceService/Infer',
        ...
        self.Health = channel.unary_unary(
                '/edgevision.InferenceService/Health',
                request_serializer=infer__pb2.HealthRequest.SerializeToString,
                response_deserializer=infer__pb2.HealthResponse.FromString,
                _registered_method=True)
...
def add_InferenceServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'Health': grpc.unary_unary_rpc_method_handler(
                    servicer.Health,
                    request_deserializer=infer__pb2.HealthRequest.FromString,
                    response_serializer=infer__pb2.HealthResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'edgevision.InferenceService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('edgevision.InferenceService', rpc_method_handlers)
...
class InferenceService:
    ...
    def Health(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/edgevision.InferenceService/Health',
            infer__pb2.HealthRequest.SerializeToString,
            infer__pb2.HealthResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
